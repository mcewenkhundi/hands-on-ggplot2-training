...
* Inspect the data.
```{r chicago_weather}
data_weather_chicago <- readr::read_csv("https://raw.githubusercontent.com/z3tt/ggplot-courses/master/data/chicago-nmmaps.csv")

data_weather_chicago

tibble::glimpse(data_weather_chicago)

summary(data_weather_chicago)
```
